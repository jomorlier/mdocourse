function [c,ceq,dc,dceq]=aggregated_relaxed_unified_stress_constraints(x,P)
E_1=210000; %MPa
E_2=70000; %MPa
L_1=2000; %mm
L_2=1750; %mm
...
barg_1rel=(abs(s_1)/sl_1-1).*(A_1/100);
barg_2rel=(abs(s_2)/sl_2-1).*(A_2/100);
G_ks_2=1/P*log(1/2*(exp(P*(barg_1rel))+exp(P*(barg_2rel))));
 c=[G_ks_2];ceq=[];
